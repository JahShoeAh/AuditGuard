          ...
          <div className="flex items-start justify-between p-5 border-b border-gray-800">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] font-bold font-mono uppercase tracking-widest text-green-400">
            ...
            <div className="border border-cyan-500/20 rounded-xl p-4 bg-cyan-500/5">
              ...
              {listing.contentHash && (
                <div className="mt-2">
                  ...
                  <p className="text-[11px] font-mono text-cyan-500 break-all">{listing.contentHash}</p>
                </div>
              )}
              <div className="flex gap-3 mt-3">
                <a
                  href={hashscan.transaction(listing._tx?.txId || listing.contentHash?.slice(2, 18) || '')}
                  target="_blank"
                  rel="noreferrer"
