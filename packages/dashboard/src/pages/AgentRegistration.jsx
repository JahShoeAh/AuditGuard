...
export default function AgentRegistration() {
  ...
  const handleMockRegister = () => {
    if (!requireWallet('register an agent')) return;
    setStatus('Wallet unlocked. Agent registration flow will be wired in Prompt 4.');
  };
  ...
  return (
    <div className="h-screen bg-gray-950 text-gray-100 flex flex-col">
      ...
      <main className="mx-auto w-full max-w-3xl px-6 py-8">
        ...
        <h1 className="mt-4 font-mono text-2xl font-semibold uppercase tracking-wider">Agent Registration</h1>
